...
// Connect to MongoDB
mongoose.connect('mongodb+srv://admin:mongoo69@cluster0.rpbsye0.mongodb.net/blog?retryWrites=true&w=majority&appName=Cluster0', { useNewUrlParser: true, useUnifiedTopology: true });
...
db.once('open', async () => {
  ...
  function generateBody() {
    const sampleText = "This is a sample body for the article. It should contain meaningful content that showcases various aspects of the topic being discussed. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.";
    let body = '';
    // Repeat the sample text multiple times to make the body large
    for (let i = 0; i < 10; i++) {
